...
private:
   ...
   **/
   ...
   /**
	  @brief Removes all occurences of the node @c id in the neighborlist by remove-erase.
   **/
...
public:
   ...
   **/
   ...
   /**
      @return A reference to the id-th entry in the array of @c Nodes of this graph.
   **/
   ...
   **/
   ...
   /**
      @brief Removes all occurrences of the edge <tt> {node1_id, node2_id} </tt> from this graph.
	  
      This method removes all the occurences of both @c node1_id as a neighbor of @c node2_id and @c node2_id as a neighbor of @c node1_id.
   **/
   void delete_edge(NodeId node1_id, NodeId node2_id);  
